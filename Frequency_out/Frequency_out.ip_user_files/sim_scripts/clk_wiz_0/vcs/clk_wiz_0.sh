...
#
# Generated by Vivado on Mon Nov 25 16:14:15 CET 2024
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"/opt/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"/opt/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"/opt/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../Frequency_out.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../Frequency_out.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/bernardo/vivado/Frequency_out/Frequency_out.cache/compile_simlib/vcs"
  fi
