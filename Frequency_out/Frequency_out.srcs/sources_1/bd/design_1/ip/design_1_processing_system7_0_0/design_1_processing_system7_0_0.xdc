...
#The clocks are asynchronous, user should constrain them appropriately.#
create_clock -name clk_fpga_2 -period "8.125" [get_pins "PS7_i/FCLKCLK[2]"]
set_input_jitter clk_fpga_2 0.24375
#The clocks are asynchronous, user should constrain them appropriately.#
create_clock -name clk_fpga_3 -period "6.875" [get_pins "PS7_i/FCLKCLK[3]"]
set_input_jitter clk_fpga_3 0.20625
#The clocks are asynchronous, user should constrain them appropriately.#
